...
def info_vacancy(vacancies_list):
    for i in vacancies_list:
        ...
        yield name, link_split[0], salary_min, salary_max, currency, 'hh.ru'
...
def collector_of_vacancies(vacancy):
    ...
    while True:
        ...
        for i in vacancies:
            ...
            item_check = list(vacancies_col.find({'link': link}))  # Проверка на наличие вакансии в базе данных по ссылке на неё
            if len(item_check) == 0:
...
# вывод - после добавления проверки по link почему-то все время разное количество вакансий в базу добавляет
...
# {'_id': ObjectId('5ee2a518fdf5dc5541affc3f'),
#  'currency': 'руб.',
#  'link': 'https://hh.ru/vacancy/37072140',
